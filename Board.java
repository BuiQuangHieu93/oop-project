...
public class Board extends JPanel implements KeyListener, MouseListener, MouseMotionListener{
	...
	public Board(){
		...
		background = ImageLoader.loadImage("/background1.jpg");
		pause = ImageLoader.loadImage("/pause.png");
		refresh = ImageLoader.loadImage("/refresh.png");
		
		music = ImageLoader.LoadSound("/music1.wav");
    ...
    int checkback=-1;
    public int checkbackground(int b) {
    ...
    int checkmusic=-1;
    public int checkmusic(int b) {
    	checkmusic=checkmusic+1;
    	if(checkmusic>b-1) {
    		return checkmusic=-1;
    	} 	
    	return checkmusic;
	...
	public void keyPressed(KeyEvent e) {
		...
		if(e.getKeyCode() == KeyEvent.VK_B) {
			...
			case 1:
				...
				break;
			case 2:
				background = ImageLoader.loadImage("/background2.jpg");
				break;
			case 3:
				background = ImageLoader.loadImage("/background3.jpg");
				break;
			default:
		...
		if(e.getKeyCode() == KeyEvent.VK_M) {
			int value = checkmusic(8);
	
            music.stop();
			switch(value) {
			case 0:
				music = ImageLoader.LoadSound("/music2.wav");
				break;
			case 1:
				music = ImageLoader.LoadSound("/music3.wav");
				break;
			case 2:
				music = ImageLoader.LoadSound("/music4.wav");
				break;
			case 3:
				music = ImageLoader.LoadSound("/music5.wav");
				break;
			case 4:
				music = ImageLoader.LoadSound("/music6.wav");
				break;
			case 5:
				music = ImageLoader.LoadSound("/music7.wav");
				break;
			case 6:
				music = ImageLoader.LoadSound("/music8.wav");
				break;
			case 7:
				music = ImageLoader.LoadSound("/music1.wav");
				break;
